 ...
 * Maneja las operaciones de creación, consulta y modificación de listas de multimedia.
 *
...
public class ListaService {
     ...
     * @throws IllegalArgumentException si la lista no existe o no pertenece al usuario
     */
    @Transactional(readOnly = true)
